	...
	groups: [
		{
			items: [
				...
				},
				{
					...
					html: '<d-textarea ico-lead="d-ico-star" label="Label" value="Value">\n</d-textarea>'
				},
				{
					title: 'd-textarea Empty Leading Icon',
					html: '<d-textarea ico-lead="d-ico-star" label="Label"></d-textarea>'
				},
				{
					title: 'd-textarea Trailing Icon',
					html: '<d-textarea ico-trail="d-ico-visible" label="Label" value="Value"></d-textarea>'
				},
				{
